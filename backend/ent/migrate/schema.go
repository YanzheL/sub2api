...
var (
	...
	PasskeyCredentialsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			{
				Name:    "passkeycredential_last_used_at",
				Unique:  false,
				Columns: []*schema.Column{PasskeyCredentialsColumns[11]},
			},
			{
				Name:    "passkeycredential_revoked_at",
				Unique:  false,
				Columns: []*schema.Column{PasskeyCredentialsColumns[12]},
			},
			{
			...
			{
				Name:    "passkeycredential_user_id_last_used_at",
				Unique:  false,
				Columns: []*schema.Column{PasskeyCredentialsColumns[13], PasskeyCredentialsColumns[11]},
			},
		},
	}
